...
class FakeTravelRepository(
    ...
    override suspend fun addMember(groupId: Long, memberName: String, role: MemberRole): Long = 0L
    ...
    override suspend fun consumeInvite(code: String, memberName: String): Result<Long> = Result.success(0L)
